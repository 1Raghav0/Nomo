...
//   // Split FAQs into two columns (left and right)
...
//       {/* FAQ Grid */}
//       <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-x-10 max-w-4xl mx-auto">
//         {[leftFaqs, rightFaqs].map((column, colIndex) => (
//           <div key={colIndex}>
//             {column.map((faq, index) => {
//               // Create a unique index across both columns
//               const globalIndex =
...
//                 <div
//                   key={globalIndex}
//                   className="border-b border-gray-300 pb-3 text-left cursor-pointer transition-all duration-300 mb-6"
